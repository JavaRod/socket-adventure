...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return [
            "You are in the room with the throne.",
            "You are in the room with the fireplace.",
            "You are in the room with shelves full of books and manuscipts.",
            "You are in the room with a dragon."
        ][room_number]
